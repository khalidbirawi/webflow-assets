...
function initFloatingLabels(container = document) {
  ...
  const inputs = container.querySelectorAll(".form__input-wrapper .input");

  inputs.forEach(input => {

    // Prevent duplicate event listeners
    if (input.dataset.floatingInit === "true") return;
    input.dataset.floatingInit = "true";
